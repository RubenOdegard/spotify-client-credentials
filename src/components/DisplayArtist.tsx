...
const DisplayArtist = ({ artistID }: { artistID: string }) => {
  ...
  if (loading) {
    return (
      <span className="col-span-12 row-span-4 max-h-[400px] max-w-[400px]  animate-pulse rounded-md bg-emerald-950 xl:col-span-4 xl:col-start-1"></span>
    );
  }
      ...
      {artistData ? (
        <>
          ...
          <div className="flex items-center justify-between py-6">
            <h2 className="text-xl font-bold">{artistData.artistData.name}</h2>
