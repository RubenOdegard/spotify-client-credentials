...
const DisplayArtistRelatedArtist = ({ artistID }: { artistID: string }) => {
	...
	if (loading) {
		return (
			<span className="col-span-12 row-span-1 row-start-5 animate-pulse rounded-md bg-emerald-950"></span>
		);
	}
							...
							>
								<div className="relative h-24 w-24">
									<Image
										...
										className="aspect-square rounded-full border-2 border-emerald-800/20 object-cover shadow-inner duration-500 md:grayscale md:group-hover:grayscale-0"
									/>
